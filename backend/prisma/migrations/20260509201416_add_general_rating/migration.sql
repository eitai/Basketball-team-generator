...
INSERT INTO "new_Player" ("ballHandler", "defense", "fitness", "id", "name", "offense", "passing", "position", "rebounding", "shooting") SELECT "ballHandler", "defense", "fitness", "id", "name", "offense", "passing", "position", "rebounding", "shooting" FROM "Player";
DROP TABLE "Player";
